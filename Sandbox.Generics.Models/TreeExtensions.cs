...
namespace Sandbox.Generics.Models
{
    ...
    {
        public static ITree<TKey, TValue>? Get<TKey, TValue>(this ITree<TKey, TValue> tree, TKey key)
        ...
        public static ITree<TKey, TValue> AddOrUpdate<TKey, TValue>(this ITree<TKey, TValue> tree, TKey key, TValue value, 
