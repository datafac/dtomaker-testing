...
namespace DTOMakerV10.Tests
{
    public class JsonNewtonSoftTests
    {
        ...
        private string Roundtrip_Boolean_Value(Boolean value) => Roundtrip3<Boolean, Models.JsonNewtonSoft.Data_Boolean>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_SByte_Value(SByte value) => Roundtrip3<SByte, Models.JsonNewtonSoft.Data_SByte>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Int16_Value(Int16 value) => Roundtrip3<Int16, Models.JsonNewtonSoft.Data_Int16>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Int32_Value(Int32 value) => Roundtrip3<Int32, Models.JsonNewtonSoft.Data_Int32>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Int64_Value(Int64 value) => Roundtrip3<Int64, Models.JsonNewtonSoft.Data_Int64>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Int128_Value(Int128 value) => Roundtrip3<Int128, Models.JsonNewtonSoft.Data_Int128>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Byte_Value(Byte value) => Roundtrip3<Byte, Models.JsonNewtonSoft.Data_Byte>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_UInt16_Value(UInt16 value) => Roundtrip3<UInt16, Models.JsonNewtonSoft.Data_UInt16>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_UInt32_Value(UInt32 value) => Roundtrip3<UInt32, Models.JsonNewtonSoft.Data_UInt32>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_UInt64_Value(UInt64 value) => Roundtrip3<UInt64, Models.JsonNewtonSoft.Data_UInt64>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
...
#if NET8_0_OR_GREATER
        private string Roundtrip_UInt128_Value(UInt128 value) => Roundtrip3<UInt128, Models.JsonNewtonSoft.Data_UInt128>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Guid_Value(Guid value) => Roundtrip3<Guid, Models.JsonNewtonSoft.Data_Guid>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Char_Value(Char value) => Roundtrip3<Char, Models.JsonNewtonSoft.Data_Char>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Decimal_Value(Decimal value) => Roundtrip3<Decimal, Models.JsonNewtonSoft.Data_Decimal>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_PairOfInt16_Value(PairOfInt16 value) => Roundtrip3<PairOfInt16, Models.JsonNewtonSoft.Data_PairOfInt16>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_PairOfInt32_Value(PairOfInt32 value) => Roundtrip3<PairOfInt32, Models.JsonNewtonSoft.Data_PairOfInt32>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_PairOfInt64_Value(PairOfInt64 value) => Roundtrip3<PairOfInt64, Models.JsonNewtonSoft.Data_PairOfInt64>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_String_Value(String value) => Roundtrip3<String, Models.JsonNewtonSoft.Data_String>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Octets_Value(Octets value) => Roundtrip3<Octets, Models.JsonNewtonSoft.Data_Octets>(value, (m, v) => { ((IData_Octets)m).Value = v; }, (m) => ((IData_Octets)m).Value);
...
#if NET8_0_OR_GREATER
        private string Roundtrip_Half_Value(Half value) => Roundtrip3<Half, Models.JsonNewtonSoft.Data_Half>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Double_Value(Double value) => Roundtrip3<Double, Models.JsonNewtonSoft.Data_Double>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
        ...
        private string Roundtrip_Single_Value(Single value) => Roundtrip3<Single, Models.JsonNewtonSoft.Data_Single>(value, (m, v) => { m.Value = v; }, (m) => m.Value);
...
#if NET8_0_OR_GREATER
        //[Fact] public async Task Roundtrip_Single_MinInc_Net80() => await Verifier.Verify(Roundtrip_Single_Value(Single.Epsilon)); // todo deserialize fails
#else
        //[Fact] public async Task Roundtrip_Single_MinInc_Net48() => await Verifier.Verify(Roundtrip_Single_Value(Single.Epsilon)); // todo deserialize fails
#endif
#if NET8_0_OR_GREATER
